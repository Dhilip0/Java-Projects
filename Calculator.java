...
class Calculator extends Frame implements ActionListener {
    ...
    TextField display;
    Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, plus, minus, multiply, divide, eqauls, clear;
    ...
    Calculator()
    {
        ...
        eqauls = new Button("=");
        eqauls.setBounds(150,400,80,80);
        eqauls.addActionListener(this);
